...
public class BaseClass {
	...
	public static void screenShot(WebDriver driver) throws IOException {
		...
		Files.copy(src,new File( "D:\\Capstone_Project\\CapstoneProject\\ScreenShots\\ScreenShot"+"Page-"+System.currentTimeMillis()+".png"));
	...
	public static void defectscreenShot(WebDriver driver) throws IOException {
		...
		TakesScreenshot tr=(TakesScreenshot)driver;
		src=tr.getScreenshotAs(OutputType.FILE);
		Files.copy(src,new File( "D:\\Capstone_Project\\CapstoneProject\\ScreenShots\\DefectScreenShot"+"Page-"+System.currentTimeMillis()+".png"));
